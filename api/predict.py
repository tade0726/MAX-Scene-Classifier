...
labels_dict = MAX_API.model(
    "Labels",
    {
        ...
        "category_lvl_one": fields.String(
            required=True, description="Class label indoor/outdoor"
        ),
        "category_lvl_one_zh": fields.String(
            required=True, description="Class label indoor/outdoor zh"
        ),
    },
)
...
model_label = MAX_API.model(
    "ModelLabel",
    {
        ...
        "name": fields.Nested(labels_dict, description="Label detail"),
    },
)
...
class ModelLabelsAPI(MetadataAPI):
    ...
    def get(self):
        ...
        result = {}
        result["labels"] = [
            {"id": l[0], "name": l[1]} for l in self.id_to_class.items()
        ]
...
label_prediction = MAX_API.model(
    "LabelPrediction",
    {
        ...
        "label": fields.Nested(labels_dict, description="Label detail"),
...
class ModelPredictAPI(PredictAPI):
    ...
    def post(self):
        ...
        label_preds = [
            {"label_id": p[0], "label": p[1], "probability": p[2]}
